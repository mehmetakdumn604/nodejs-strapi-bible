...
const indexHoTsgrwy = require("./index-hoTsgrwy-QiBdpWEj.js");
...
const index = require("./index-ByErGv3I.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexHoTsgrwy.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexHoTsgrwy.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexHoTsgrwy.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-BaPWSmwg.js.map
